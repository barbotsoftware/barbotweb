...
<!--<script type="text/javascript" src="js/jquery-1.10.2.min.js"></script>-->
    ...
    <script src="js/app/dashboard/dashboard-ctrl.js"></script>
...
@section('content')
<div id="wrapper" ng-app="barbot" ng-controller="DashboardController">
          <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                <div class="row">
                    <div class="col-lg-12" id="header">
                        <div id="logoContainer">
                            <img src="img/barbot_logo.png" alt="">
                        </div>
                        <h1>Barbot <small>Dashboard</small></h1>
                        ...
                        <div id="barbotStatusContainer">Barbot Status: <img id="blinky"></img> <span id="barbotStatus">({barbotStatus})</span></div>
                    </div>
                </div>
            </div>
            <!--
        ...
        <div id="page-wrapper">
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-tachometer"></i>  Metrics</h3>
                        </div>
                ...
                <div class="col-md-6">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-bar-chart"></i> Ingredient Levels</h3>
                        </div>
                    <!--<div class="panel panel-primary">
                        <div class="panel-heading">
                        ...
                        <div class="panel-body">
                            <div id="ingredientLevelPanel">
                                <div class="ingredientLevelRow" ng-repeat="ingredientRow in ingredientLevels">
                                    <div class="ingredientLevelContainer" ng-repeat="ingredient in ingredientRow">
                                        <div class="ingredientLevelMax">
                                            <div class="ingredientName">({ingredient.ingredient.name})</div>
                                            <div class="ingredientLevel" id="fluidLevel_({ingredient.id})">
                                                
                                            </div>
                                            <div class="ingredientInfo">
                                                ({ingredient.fluidPercentage|number:0})%
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-md-3">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h3 class="panel-title"><i class="fa fa-rss"></i> Orders</h3>
                        </div>
                        <div class="panel-body feed">
                            <div id="orderFeed">
                                <div id="noOrdersMessage">No orders yet!</div>
                                <div class="orderEntry" ng-repeat="order in orders.slice().reverse()">
                                    <!--<span class="orderUser">({order.user})</span> ordered a <span class="orderDrink">({order.recipe})</span>-->
                                    <span class="orderDrink">({order.recipe})</span> ordered at <span class="orderDate">({order.date | date})</span>
                                </div>
                            </div>
                        </div>
                    </div>

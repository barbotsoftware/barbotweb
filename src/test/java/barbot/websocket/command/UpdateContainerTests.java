 ...
 */
public class UpdateContainerTests extends CommandTests {
    ...
    private void setUpTestData() {
        ...
        data.put("container", bbc);

        msg.put("data", data);

        fieldsToValidate.put("barbot_id", "required|exists:barbot");

        command = new UpdateContainer(barbotService, ingredientService, barbotContainerService, fieldValidator,
                helperMethods, msg);
    }
}
